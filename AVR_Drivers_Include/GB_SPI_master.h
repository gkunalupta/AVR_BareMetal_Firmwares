#ifndef GB_SPI_MASTER_H_
#define GB_SPI_MASTER_H_
...
char gb_RECV_DATA_SPI0[gb_RECV_BUFFER_SIZE_SPI0];
	...
	/* functions for interrupt buffer*/
	char GB_MA_SPI0_INTRPT_read_byte();
	void GB_MA_SPI0_INTRPT_read_string();
	void GB_SPI0_INTRPT_read_block(char *gb_buff, uint8_t gb_size);
