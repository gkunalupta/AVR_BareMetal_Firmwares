...
#define gb_LCD_command_dir DDRB        // --> sets the output and input for commands registers
#define gb_LCD_command_port PORTB     // --> sets the high low of pins
                                                       

//for atmega 2560
#define gb_LCD_data_dir DDRL           // data pins 0-7 (PD0:7-D0:7)--> sets the output or input for data pins
#define gb_LCD_data_port PORTL        // data pins 0-7 (PD0:7-D0:7)--> sets the high low for data pins that is data to be send  is passed to this constant
#define gb_LCD_PIN PINL

#define debug false
#define gb_LCD_RW 6     // Define Read(1)/Write(0) signal pin 
#define gb_LCD_RS 7       //Define Register Select (data(1)/command reg(0))pin 
#define gb_LCD_EN 5        // Define Enable signal pin: Set to 1 for final execution of data/command to d0-7 pins

                  // for atmega 2560                
#define gb_LCD_D0 0  //  Digital pin - 49(PL0)
#define gb_LCD_D1 1  //  Digital pin - 48(PL1)
#define gb_LCD_D2 2  //  Digital pin - 47(PL2)
#define gb_LCD_D3 3  //  Digital pin - 46(PL3)
#define gb_LCD_D4 4  //  Digital pin - 45(PL4)                
#define gb_LCD_D5 5  //  Digital pin - 44(PL5)                
#define gb_LCD_D6 6  //  Digital pin - 43(PL6)                
#define gb_LCD_D7 7  //  Digital pin - 42(PL7)                
...
#define gb_lcd_8bit_1line_11 0b00110100
#define gb_lcd_8bit_2line_11 0b00111100
#define gb_lcd_4bit_1line_11 0b00100100
#define gb_lcd_4bit_2line_11 0b00101100
...
uint8_t gb_address_counter=0; // Variable to store Address counter and Busy Flag(7th bit) Status
/*
...
*/
void GB_LCD_sendpattern(uint8_t gb_pattern[]);
